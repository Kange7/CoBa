...
# from RandLA import Network  
from LACVNet import Network  
from tester_ExpressRail import ModelTester
from helper_ply import read_ply
from helper_tool import ConfigExpressRail as cfg
...
class ExpressRail:
    def __init__(self):
        ...
        self.val_file_name = ['L02-label-1',
                              'L02-label-3',
                              'L02-label-5',
                              'L04-label-4',
                              'L06-label-3',
        ...
        self.input_xyz = {'training': [], 'validation': []}    # 新增
    ...
    def load_sub_sampled_clouds(self, sub_grid_size):
        ...
        for i, file_path in enumerate(self.all_files):
            ...
            if cloud_name in self.val_file_name:
                ...
                # print(self.val_file_name, cloud_name)
            else:
            ...
            sub_xyz = np.vstack((data['x'], data['y'], data['z'])).T  # 新增
            # print("sub_xyz shape:", sub_xyz.shape)
            ...
            self.input_xyz[cloud_split] += [sub_xyz]  # 新增
        ...
        for i, file_path in enumerate(self.all_files):
            ...
            # Validation projection and labels 这里似乎可以把Validation改成test
            if cloud_name in self.val_file_name:
    ...
    def get_batch_gen(self, split):
        ...
        def spatially_regular_gen():
            ...
            for i in range(num_per_epoch):
                ...
                cloud_idx = int(np.argmin(self.min_possibility[split]))  # 报错：空数组进行np.argmin()操作
                ...
                if len(points) < cfg.num_points:
                    queried_pc_xyz,  queried_idx, queried_pc_labels = \
                        DP.data_aug(queried_pc_xyz, queried_pc_labels, queried_idx, cfg.num_points)
...
if __name__ == '__main__':
    ...
    if Mode == 'train':
        model = Network(dataset, cfg)  # 似乎就这里有network
        model.train(dataset)
    elif Mode == 'test':
        cfg.saving = False
