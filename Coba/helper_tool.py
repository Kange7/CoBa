...
class ConfigToronto3D:
    ...
    num_layers = 5  # Number of layers
    num_points = 40960  # Number of input points
    num_classes = 9  # Number of valid classes 9就是帕会有unclassified的影响
    sub_grid_size = 0.06  # preprocess_parameter
...
class ConfigExpressRail:
    ...
    noise_init = 0.0  # noise initial parameter
    max_epoch = 60 # 100 # maximum epoch during training
    learning_rate = 1e-2  # initial learning rate
    lr_decays = {i: 0.98 for i in range(0, 500)}  # decay rate of learning rate
...
class ConfigSNCF:
    ...
    num_layers = 5  # Number of layers
    num_points = 40960  # Number of input points
    num_classes = 8  # Number of valid classes 9就是帕会有unclassified的影响
    sub_grid_size = 0.06  # preprocess_parameter
...
class ConfigWHUurban:
    k_n = 16  # KNN
    num_layers = 5  # Number of layers
    num_points = 40960  # Number of input points
    num_classes = 11  # Number of valid classes 9就是帕会有unclassified的影响
    sub_grid_size = 0.06  # preprocess_parameter
...
class DataProcessing:
    ...
    def read_ply_data(path, with_rgb=True, with_label=True):
        ...
        if with_rgb and with_label:
            ...
            labels = data['scalar_Classification_-_1']
            ...
            labels = data['scalar_class']  # scalar_label
    ...
    def get_class_weights(dataset_name, num_per_class=0, name='sqrt'):
        ...
        elif dataset_name == 'SensatUrban' or dataset_name == 'Toronto3D'or dataset_name == 'ExpressRail' or dataset_name == 'WHUurban' or dataset_name == 'SNCF' or dataset_name == 'Pairs3D' or dataset_name == 'ScanNet':
