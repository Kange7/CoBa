...
if __name__ == '__main__':
    ...
    dataset_name = 'SNCF'
    dataset_path = '/home/joe/program/CoBa/Data/SNCF/'
    ...
    val_files = np.sort([join(dataset_path, 'val', i) for i in os.listdir(join(dataset_path, 'val'))])  # 新增验证集
    ...
    files = np.sort(np.hstack((train_files, val_files, test_files)))
