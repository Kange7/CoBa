...
if __name__ == '__main__':
    ...
    dataset_name = 'ExpressRail'
    dataset_path = '/home/joe/program/CoBa/Data/ExpressRail-PLY/'
    ...
    for sample_type in preparation_types:
        for pc_path in files:
            ...
            # help(DP.grid_sub_sampling)
            if sample_type == 'grid':
                sub_xyz, sub_labels = DP.grid_sub_sampling(xyz, features=None, labels=labels, grid_size=grid_size)
            else:
                sub_xyz, sub_labels = DP.random_sub_sampling(xyz, features=None, labels=labels, grid_size=random_sample_ratio)
